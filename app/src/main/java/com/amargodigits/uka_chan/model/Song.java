...
public class Song implements Parcelable {
    ...
    public Song(String songId, String title, String singer, String img, String text, String language, String update_timestamp, String view_timestamp, String link, String liked) {
        this.songId = songId;
        this.title = title;
        this.singer = singer;
        this.img = img;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeStringArray(new String[]{songId, title, singer, img, text,
                language, update_timestamp, view_timestamp, link, String.valueOf(liked)});
    }
